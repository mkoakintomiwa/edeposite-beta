...
var prompt = exports.prompt = function(prompt_placeholder,default_value=""){
    var _return;
...
var info_prompt = exports.info_prompt = function(message,subject,default_value=null){
    _default_value = `""`;
    ...
    return new Promise(async resolve=>{
        ...
        var output = _=>{
            ...
            promise().then(async set=>{
                r.push(set);
                console.log("\n");
                await prompt(chalk.redBright(`Do you want to add another ${title} (Y/N) `)).then(p=>{
