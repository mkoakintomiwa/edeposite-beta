interface JQuery{
    ...
    letteringInput(pinInputOptions: any): void;
}
...
declare var hierarchies: any;

declare var hierarchy_indexes: any;
...
declare function addDialog(container: HTMLElement, content: string): void;
...
declare function np(content?: string, element?: HTMLElement): void;

declare function _swal(m: any, y?: string): void;

declare function sp(m?: string): void;

declare function npClose(): void;

declare function encodedURL(main_link: any, queryStringObject?: {}): any;

declare function _user(public_address: string): Promise<User>;

declare function SpClose(): void;