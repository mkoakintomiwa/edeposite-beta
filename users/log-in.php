...
if (isset($_GET["public_address"])){
    ...
    if ($c===1){
        ...
        if ($private_key===$user->private_key){
            $_SESSION["public_address"] = $public_address;
...
<body>
	...
	<div class="main-w3layouts wrapper">
		<div style="display: flex; justify-content:center; align-items: center; flex-direction:column;">
			...
			<h3 style="color: white; font-size: 30px;">Log In</h3>
		</div>

		<div class="main-agileinfo" >
			<div class="agileits-top">
				<form id="ico-login-form">
					...
					<div class="user-form">
						...
						<div class="input-field">
							...
							<textarea class="text email materialize-textarea" type="email" name="private_key"></textarea>
						</div>
...
<script>
	$("#login-button").on("click",function(e){e.preventDefault();Sp();var formdata=$("#ico-login-form").formJSON();$.ajax({url:"".concat(ajax,"/check-user.php"),data:Object.assign(formdata,{login:"true"}),success:function(d){var response=jsonResponse(d);switch(response.status){case "correct":window.location.href=encodedURL('',formdata);break;case "wrong":Swal.fire({icon:'error',html:"Wrong credentials, check and try again"});break;}}});});
</script>